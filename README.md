...
1- install QD-master.zip library

2- go to ODE and then go to the folder you would like to test

3- the first line of each finename.cpp is the command line to compile

4- any trouble, contact clain@mat.uc.pt
