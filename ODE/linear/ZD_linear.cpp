//g++ ZD_linear.cpp -O2 -lqd  -o ZD_linear -mavx2
#include<iostream>
#include <iomanip>
#include <fstream>
#include <string>
...
//#define real float
//#define real double
//#define real long double   //80bit
//#define real __float128    //strict 128 bit
#define real dd_real
//#define real qd_real
...
int main()
    ...
    size_t nb_iter=0;
    real t=0,err=0;
    real T=1.,N =320,Dt=T/N;
    std::ofstream file;
    file.open("linear_ZD.txt");
...
//------ output ----------
    ...
    /*
    file<<std::scientific<<(double)t<<"  "<<chem.count;
    file<<std::scientific<<"  "<<(double)chem.Z(0)<<"  "<<(double)chem.Z(1)<<"  "<<(double)chem.Z(2)<<"  "<<(double)chem.Z(3);
*/
